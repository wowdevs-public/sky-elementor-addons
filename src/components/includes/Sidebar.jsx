    ...
    <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/20 dark:border-gray-800">
      ...
      {isLargeScreen && (
        <button
          ...
          aria-label={isSidebarOpen ? __('Hide Menu', 'sky-elementor-addons') : __('Show Menu', 'sky-elementor-addons')}
          title={isSidebarOpen ? __('Hide Menu', 'sky-elementor-addons') : __('Show Menu', 'sky-elementor-addons')}
        >
          <FontAwesomeIcon
