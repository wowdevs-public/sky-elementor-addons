    ...
    <>
      ...
      >
        <p className="mb-4 text-center md:text-left text-sm text-gray-500 dark:text-gray-400 sm:mb-0">
          {__("Thank You for Using ", 'sky-elementor-addons')}
          {" "}
          <strong>
            (Core v{SkyAddonsConfig.version}
            {SkyAddonsConfig.pro_version && (
              <span> & Pro <strong>v{SkyAddonsConfig.pro_version}</strong></span>
            )})
          </strong>
          <br />
          {" "}{__("By - ", 'sky-elementor-addons')}
