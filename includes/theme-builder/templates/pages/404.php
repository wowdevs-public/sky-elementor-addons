<?php
/**
 * Sky Addons Theme Builder — 404 template.
 *
 * Swapped in by Theme_Builder::set_builder_template() when a matching
 * "404" template is enabled. Copy this file into your theme only if you
...
\Sky_Addons\ThemeBuilder\Theme_Builder::render_template( '404' );
